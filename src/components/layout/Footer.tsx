...
export function Footer({ activeCount, removedCount, starredCount, appliedCount }: FooterProps) {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 text-center md:text-left">
          ...
          <div className="md:text-right flex flex-col items-center md:items-end">
            ...
            <div className="flex flex-wrap justify-center md:justify-end gap-2">
              ...
              <span className="inline-flex items-center px-3 py-1 rounded-lg text-xs font-black bg-blue-50 dark:bg-blue-905/20 text-blue-800 dark:text-blue-300 border border-blue-200 dark:border-blue-900/30">{appliedCount} TRACKED</span>
