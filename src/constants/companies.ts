...
export const COMPANY_DETAILS: Record<string, CompanyInfo> = {
  'Airwallex': {
    name: 'Airwallex',
...
export const TRACKED_COMPANIES = Object.keys(COMPANY_DETAILS).sort();
